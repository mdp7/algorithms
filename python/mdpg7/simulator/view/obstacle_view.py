...
from mdpg7.config.constants import SimulatorConst, ObstacleConst
from mdpg7.utils.log_utils import print_warning


def draw_obstacle(simulator, obstacle):
	# TODO: add stop position
	win_x, win_y = obstacle.win_pos()

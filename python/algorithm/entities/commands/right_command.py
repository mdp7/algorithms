...
class RightTurn(TurnCommand):
    ...
    def process_one_tick(self, robot):
        ...
        robot.right_turn(angle, self.rev)
    ...
    def apply_on_pos(self, curr_pos: Position):
        ...
        x_change = const.ROBOT_RIGHT_TURN_RADIUS * (math.sin(math.radians(curr_pos.angle + self.angle)) -
                                              math.sin(math.radians(curr_pos.angle)))
        y_change = const.ROBOT_RIGHT_TURN_RADIUS * (math.cos(math.radians(curr_pos.angle + self.angle)) -
